    ...
    public class Questions_IPV
    {
        ...
        public static List<Questions_IPV> GetQuestions()
        {
            return new List<Questions_IPV>
            {
                ...
                {
                    QuestionNumber = 1,
                    Question = "T... debe salir de viaje con una persona de la que no conoce nada. ¿Sobre cuál de los siguientes aspectos de esa persona es preferible informar a T. para que el viaje resulte mejor?",
                ...
                {
                    QuestionNumber = 41,
                    Question = "L... asiste a un partido de fútbol entre dos equipos muy conocidos. El partido es muy disputado y los dos equipos rinden al máximo. Entre los espectadores el entusiasmo es tremendo y...",
                ...
                {
                    QuestionNumber = 42,
                    Question = "B... atraviesa la calle por un paso de peatones con el semáforo en rojo. Un coche llega a gran velocidad y se detiene repentinamente a pocos centímetros de B... ¿Cuál va a ser la reacción inmediata de este?",
                ...
                {
                    QuestionNumber = 43,
                    Question = "A su modo de ver, ¿Cuál es, entre los siguientes aspectos, el más desatendido actualmente en la educación de su hijo?",
                ...
                {
                    QuestionNumber = 44,
                    Question = "T... acaba de fracasar en un examen. Uno de sus amigos le dice que algunos fracasos son útiles en la vid¿Qué responderá él?",
                ...
                {
                    QuestionNumber = 45,
                    Question = "L... se encuentra en una reunión amistosa. Sabe muy bien que la mayor parte de las personas presentes tienen opiniones muy diferentes a las suyas. ¿Qué piensa usted que hará?",
                ...
                {
                    QuestionNumber = 46,
                    Question = "¿Qué cualidad le parece más útil en las relaciones sociales?",
                ...
                {
                    QuestionNumber = 47,
                    Question = "M... acaba de modificar totalmente se apartamento. Invita a sus amigos a la inauguración. Ente los cumplidos que le hagan, ¿Cuál será para él el más agradable?",
                ...
                {
                    QuestionNumber = 48,
                    Question = "S... llega en el momento de una discusión entre dos personas a las que conoce poco. El tema del que hablan, muy específico, le es totalmente desconocido y apenas le interesa. ¿Cuál será su reacción?",
                ...
                {
                    QuestionNumber = 49,
                    Question = "R... llega con retraso a una reunión de copropietarios. ¿Qué es lo que probablemente le molestara más?",
                ...
                {
                    QuestionNumber = 50,
                    Question = "Se ha pedido a F... un informe lo más objetivo posible sobre su modo de ser. ¿Quién decidirá él que lo haga?",
                    OptionA = "Su mujer.",
                ...
                {
                    QuestionNumber = 51,
                    Question = "X... quiere construir una cas¿Cuál de las siguientes soluciones elegirá?",
                ...
                {
                    QuestionNumber = 52,
                    Question = "T... es un hombre de negocios generalmente muy ocupado. Una cita anulada a última hora le permite tener una mañana libre totalmente imprevista. ¿Cómo cree usted que la utilizará?",
                ...
                {
                    QuestionNumber = 53,
                    Question = "D... va a ir a un país del que no conoce nada, para preparar su viaje, ¿Qué cree usted que hará?",
                ...
                {
                    QuestionNumber = 54,
                    Question = "Se oye decir frecuentemente decir que si una persona cae de repente sobre la acera a las seis de la tarde, un momento en que las calles están abarrotadas, ningún viandante se detiene para ofrecer su ayuda a la persona en dificultades. ¿A qué cree usted que se debe esta conducta?",
                ...
                {
                    QuestionNumber = 55,
                    Question = "Una señora va a consultar a un medico sobre una infección que le parece bastante banal. El médico la interroga ampliamente antes de examinarla. Ella contesta, por supuesto, a las preguntas, pero, en el fondo, ¿Qué pensará?",
                ...
                {
                    QuestionNumber = 56,
                    Question = "C... tiene que contratar empleados de oficina; dispone de poco tiempo. ¿Qué método empleará?",
                ...
                {
                    QuestionNumber = 57,
                    Question = "El mejor delegado de personal es aquel que...",
                ...
                {
                    QuestionNumber = 58,
                    Question = "La señora D... trata inútilmente de hacer que coma su hijo de cinco años; este se resiste violentamente. ¿Qué hará ella?",
                ...
                {
                    QuestionNumber = 59,
                    Question = "Se habla frecuentemente del respeto a las “reglas de juego”. En general, se trata de...",
                ...
                {
                    QuestionNumber = 60,
                    Question = "C... que es aficionado al bricolaje, decide tapizar el mismo sillón valioso. Cuando llega a la mitad de su trabajo se da cuenta de que corre el peligro de fracasar en su intento. ¿Cuál será su decisión?",
                ...
                {
                    QuestionNumber = 61,
                    Question = "C... va a ir con su mujer al campo durante los días de pascua. Previendo la afluencia, ha reservado billetes de ferrocarril. Salen de su casa a la hora justa, pero un embotellamiento en los alrededores de la estación les hace perder el tren. ¿Cómo cree usted que reaccionará?",
                ...
                {
                    QuestionNumber = 62,
                    Question = "A su juicio, la mayoría de los fracasos son debidos a...",
                    OptionA = "Incapacidad.",
                ...
                {
                    QuestionNumber = 63,
                    Question = "F... ha encargado una refrigeradorEn su ausencia, lo depositan en casa del conserje. El embalaje esta estropeado, por lo cual la refrigeradora ha sufrido algunos daños. F... decide hacer una gestión ante los servicios de distribución. ¿De qué forma se comportará?",
                ...
                {
                    QuestionNumber = 64,
                    Question = "Con ocasión de un viaje organizado, B... se encuentra con personas que no conoce. Al cabo de unos días se da cuenta que la mayoría de las personas le tienen poca simpatía. ¿Cómo cree usted que reaccionará?",
                ...
                {
                    QuestionNumber = 65,
                    Question = "R... hace un viaje con algunos amigos. Una tarde el grupo se separa después de haberse puesto de acuerdo en la hora para la salidA lo largo de esta tarde, R... descubre un monumento que le interesa mucho visitar, pero, si lo hace, le será imposible llegar a la cit¿Qué hará?",
                ...
                {
                    QuestionNumber = 66,
                    Question = "¿Cuál de estas profesionales le parece a usted la mas envidiable?",
                ...
                {
                    QuestionNumber = 67,
                    Question = "A causa de un accidente que ha causado la muerte de los padres de un niño pequeño, J... tiene que encargarse del niño con carácter definitivo. ¿Cuál será la actitud más probable que tendrá a este respecto?",
                ...
                {
                    QuestionNumber = 68,
                    Question = "Un amigo propone a T... llevarle en su velero a hacer un pequeño crucero. T... nunca ha practicado la vel¿Qué cree usted que decidirá?",
                ...
                {
                    QuestionNumber = 69,
                    Question = "T... va hacia el trabajo por su camino habitual. Una furgoneta de reparto le bloquea durante un buen rato en una calle estrechA juicio de usted, ¿Qué será lo más agradable para T...?",
                ...
                {
                    QuestionNumber = 70,
                    Question = "G... trabaja en una empresa para la que debe efectuar frecuentes desplazamientos. Acostumbra a hacer dos horas de atletismo todas las semanas en una sesión de entrenamiento colectivo. A juicio de usted, ¿Cuál es su actitud en el curso de esta sesión?",
                ...
                {
                    QuestionNumber = 71,
                    Question = "Según su criterio, ¿Cuál es la ventaja de tener un perro en un apartamento de la ciudad?",
                ...
                {
                    QuestionNumber = 72,
                    Question = "En el transcurso de una reunión en que S... se ha encontrado con amigos, les propone termina la velada en su casAl enterarse, se une a ellos una persona que se mantenía alejada del grupo a la que él estima poco. ¿Cuál será la reacción de S...?",
                ...
                {
                    QuestionNumber = 73,
                    Question = "El director de un centro de delincuentes debe contratar a un nuevo educador. ¿A cuál de estas cualidades dará más importancia?",
                ...
                {
                    QuestionNumber = 74,
                    Question = "Según su opinión, ¿Qué es más importante en una persona que da una fiesta?",
                ...
                {
                    QuestionNumber = 75,
                    Question = "R... ha de exponer un proyecto a un colega que no conoce. Para que R... pueda hacerse comprender por su interlocutor, es preferible que...",
                ...
                {
                    QuestionNumber = 76,
                    Question = "Si tuviera que hacer algún reproche a la profesión médica, ¿Cuál escogería?",
                ...
                {
                    QuestionNumber = 77,
                    Question = "N... tiene que escoger un plan de formación para las personas de su departamento. Desearía una formación interesante para todos, pero, a la vez, eficaz y rentable. ¿Qué elegiría?",
                ...
                {
                    QuestionNumber = 78,
                    Question = "M... acaba de tener un ataque de hígado. Sin embargo un amigo le llama para invitarle a comer, precisando que le ha preparado su plato favorito. Supuesto que este plato está contraindicado en este momento, ¿Cuál será la reacción de M...?",
                ...
                {
                    QuestionNumber = 79,
                    Question = "M... no está satisfecho con la Seguridad Social. Lo que más le desagrada es...",
                ...
                {
                    QuestionNumber = 80,
                    Question = "N... ha decidido consagrar una parte de su tiempo libre a ayudar a las personas de la tercera edad. Existen varias posibilidades. ¿Cuál elegirá en último lugar, cuando no hay otras alternativas?",
                ...
                {
                    QuestionNumber = 81,
                    Question = "Entre los siguientes argumentos publicitarios, ¿Cuál tiene más probabilidades de influir en el publico?",
                ...
                {
                    QuestionNumber = 82,
                    Question = "En el transcurso de un viaje en tren, D... se encuentra en un comportamiento abarrotado. Su vecino fuma y el humo le molesta mucho. Ya le ha rogado que dejara de fumar, sin resultado. ¿Qué hará?",
                ...
                {
                    QuestionNumber = 83,
                    Question = "El director del departamento de una empresa de productos alimenticios desea lanzar al mercado un nuevo postre. Dispone de un presupuesto que puede repartir en los tres conceptos que se citan a continuación. ¿En cuál de ellos empleara más dinero?",
                ...
                {
                    QuestionNumber = 84,
                    Question = "B... toma parte de una discusión muy animada en el transcurso de la cual sus opiniones son muy atacadas. Entre las actitudes siguientes, ¿Cuál será la que adopte?",
                ...
                {
                    QuestionNumber = 85,
                    Question = "Cuando usted va a un restaurante, ¿Qué tipo de plato prefiere?",
                ...
                {
                    QuestionNumber = 86,
                    Question = "Después de un naufragio, C... llega solo a una isla desierta. El clima es muy agradable y lo vegetación le permitirá encontrar el alimento necesario. ¿Qué es, a su modo de ver, lo que probablemente le planteara menos problemas?",
                ...
                {
                    QuestionNumber = 87,
                    Question = "J... dirige una importante firma automovilista. Puede escoger entre varias políticas comerciales. ¿Cuál elegirá?",
